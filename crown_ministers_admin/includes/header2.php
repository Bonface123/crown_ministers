                ...
                <div class="row gx-0">
                    ...
                    <div class="col-lg-5 text-end">
                        <div class="h-100 d-inline-flex align-items-center">
                            ...
                            <a class="text-body ps-4" href="../admin/login.php"><i class="fa fa-lock text-dark me-1"></i> Signup/Login</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <nav class="navbar navbar-light navbar-expand-lg py-3">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav ms-lg-auto mx-xl-auto">
                        ...
                        <a href="../admin/events.php" class="nav-item nav-link">Events</a>
                        <a href="../admin/youtube.php" class="nav-item nav-link">Songs</a>
                        <a href="../admin/team.php" class="nav-item nav-link">Team</a>
