    ...
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            <?php if (!empty($songs)): ?>
                ...
                <?php foreach ($songs as $song): ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="activity-item shadow-sm rounded overflow-hidden wow fadeIn" data-wow-delay="<?= $delay ?>s">
                            <!-- Dynamically display song cover -->
                            <img src="<?= !empty($song['song_cover']) ? 'uploads/' . htmlspecialchars($song['song_cover']) : 'img/choir10.jpg' ?>" 
                                 class="img-fluid w-100" 
                                ...
                                <div class="song-meta d-flex justify-content-between pb-2">
                                    <div>
                                        <small>
                                            ...
                                            <?= htmlspecialchars($song['uploaded_on']) ?>
                                        </small>
                                    </div>
                                    <div>
            ...
            <?php else: ?>
                ...
                <p class="text-center">No choir songs available at the moment. Check back soon!</p>
            <?php endif; ?>
        </div>
    </div>
</div>
